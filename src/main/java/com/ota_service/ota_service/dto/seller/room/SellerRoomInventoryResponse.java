...
@Builder
public record SellerRoomInventoryResponse(
    ...
    public static SellerRoomInventoryResponse from(RoomInventory roomInventory) {
        return SellerRoomInventoryResponse.builder()
