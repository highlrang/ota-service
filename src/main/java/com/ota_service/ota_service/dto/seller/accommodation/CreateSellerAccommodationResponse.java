...
@Builder
public record CreateSellerAccommodationResponse(
        String code,
        String name,
    ...
    public static CreateSellerAccommodationResponse of(Accommodation accommodation, AccommodationDetail detail) {
        return CreateSellerAccommodationResponse.builder()
