...
@Builder
public record ExtranetAccommodationDetailResponse(
        ...
        List<ExtranetRoomSummaryResponse> rooms,
        @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
        @Schema(description = "판매자 상품 등록 일시", example = "2026-04-03 10:15:30")
        LocalDateTime createdAt
) {
    public static ExtranetAccommodationDetailResponse of(
            Accommodation accommodation,
            AccommodationDetail detail,
            List<ExtranetRoomSummaryResponse> rooms,
            ExtranetAccommodation extranetAccommodation
    ) {
        return ExtranetAccommodationDetailResponse.builder()
                ...
                .rooms(rooms)
                .createdAt(extranetAccommodation.getCreatedAt())
                .build();
    }
}
