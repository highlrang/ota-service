...
import com.ota_service.ota_service.service.ExtranetAuthService;
...
@Tag(name = "Extranet Auth")
@RestController
@RequestMapping("/api/extranet")
@RequiredArgsConstructor
public class ExtranetAuthController {

    private final ExtranetAuthService extranetAuthService;
    ...
    public ResponseEntity<ApiResponse<LoginResponse>> login(@Valid @RequestBody LoginRequest request) {
        return ResponseEntity.ok(ApiResponse.success(extranetAuthService.login(request)));
    }
}
