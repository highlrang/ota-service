...
- 설명: 판매자 숙소를 등록한다.
- 경로: `POST /api/seller/accommodations`
...
- 경로: `GET /api/seller/accommodations`
...
- 경로: `GET /api/seller/accommodations/{accommodationCode}`
...
- 경로: `POST /api/seller/rooms/images/upload`
...
- 경로: `POST /api/seller/accommodations/{accommodationCode}/rooms`
...
- 경로: `GET /api/seller/rooms/{roomCode}`
...
- 경로: `PATCH /api/seller/accommodations/{accommodationCode}`
...
- 경로: `PATCH /api/seller/rooms/{roomCode}`
...
- 경로: `PUT /api/seller/rooms/{roomCode}/images`
...
- 경로: `PUT /api/seller/rooms/{roomCode}/rates`
...
- 경로: `PUT /api/seller/rooms/{roomCode}/inventories`
